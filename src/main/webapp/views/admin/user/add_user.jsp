...
<!-- BEGIN CONTENT -->
	...
	<!-- END STYLE CUSTOMIZER -->
				...
				<form role="form" action="${add }" method="post"
						...
						<div class="form-group">
							<label>Is_seller:</label> <input type="checkbox" class="form-control"
								placeholder="please enter username" name="is_seller" value="1"/>
						</div>
						<div class="form-group">
							<label>Is_admin:</label> <input type="checkbox" class="form-control"
								placeholder="please enter username" name="is_admin" value="1" />
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label>Birthdate:</label> <input class="form-control"
								placeholder="please enter birthdate" name="birthdate" value="${calendar.getTime() }"/>
						</div>
						<div class="form-group">
