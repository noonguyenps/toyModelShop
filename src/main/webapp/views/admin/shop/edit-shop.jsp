...
<c:url value="/admin/shop/edit" var="edit"></c:url>
	...
	<!-- END STYLE CUSTOMIZER -->
				...
				<form role="form" action="${edit }" method="post"
						...
						<div class="form-group">
							<label>ID category: ${shop.id } </label>
						</div>
						<div class="form-group">
							<label>Location :</label> <input class="form-control"
								placeholder="please enter location" name="location" value="${shop.location}"/>
						</div>
						<div class="form-group">
							<label>Name shop:</label>
							<input class="form-control"
								placeholder="please enter name of shop" name="name" value="${shop.name}"/> 
						</div>
