...
<c:url value="/admin/sub_category/add" var="add"></c:url>
	...
	<!-- END STYLE CUSTOMIZER -->
				...
				<form role="form" action="${add }" method="post"
						...
						<div class="form-group">
							<label>Name SubCategory:</label> <input class="form-control"
								placeholder="please enter subcategory name" name="name"/>
						</div>
						<div class="form-group">
							<label>Category ID:</label> <input class="form-control"
								placeholder="please enter ID category of subcategory" name="category_id" />
						</div>
